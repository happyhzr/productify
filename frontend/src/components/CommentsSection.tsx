...
type Comment = { id: string, user: { imageUrl: string, name: string }, createdAt: string, content: string, userId: string }

function CommentsSection({ productId, comments = [], currentUserId }: { productId: string, comments: Comment[], currentUserId: string }) {
